...
- (void)drawRect:(CGRect)rect {
    ...
    UIBezierPath *circlePath = [UIBezierPath bezierPathWithRect:CGRectMake(0, (height-width)/2, width, width)];
    ...
    CGContextAddRect(context,CGRectMake(0, (height-width)/2, width, width));//画方框
    //4.设置绘图属性
