...
@interface HSGHHomeThirdView () <UITableViewDelegate, UITableViewDataSource,
UIScrollViewDelegate, UITextViewDelegate> {
    
}
@property(nonatomic, assign)CGFloat offsetY_last;
@end
@implementation HSGHHomeThirdView
...
- (UITableViewCell*)tableView:(UITableView*)tableView cellForRowAtIndexPath:(NSIndexPath*)indexPath
{
  ...
  //  [cell setModelF:self.dataFrameArr[indexPath.row] showDistance:YES];
    ...
    cell.forwardBtnClickBlock = ^{
        [self forwardWithQqianVO:weakSelf.dataFrameArr[indexPath.row].model succBlock:^{
    ...
    cell.upBtnClickBlock = ^ (CGRect frame){
        ...
        [HSGHNetworkSession postReq:HSGHHomeQQiansUPURL
                       appendParams:@{@"qqianId" : weakSelf.dataFrameArr[indexPath.row].model.qqianId }
    ...
    cell.headShareBtnClickBlock = ^{
        ...
        view.block = ^(NSInteger type){
            ...
            HSLog(@"---homeThirdView---share---删除成功后");
