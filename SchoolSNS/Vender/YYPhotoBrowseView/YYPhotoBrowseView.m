...
- (void)setItem:(YYPhotoGroupItem *)item {
    ...
    [_imageView yy_setImageWithURL:item.largeImageURL placeholder:item.thumbImage options:YYWebImageOptionAllowInvalidSSLCertificates progress:^(NSInteger receivedSize, NSInteger expectedSize) {
        @strongify(self);
        if (!self) return;
...
- (void)presentFromImageView:(UIView *)fromView
    ...
    _fromNavigationBarHidden =  YES; // [UIApplication sharedApplication].statusBarHidden;
